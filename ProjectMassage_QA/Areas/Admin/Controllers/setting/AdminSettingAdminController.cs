    ...
    public class AdminSettingAdminController : BaseController
    {
        ...
        public JsonResult Save_Setting_Admin(SettingAdmin[] arr_list_setting)
        {
            ...
            try
            {
                ...
                var settingg = db.SettingAdmins.Where(x => x.ID_User == Id_session).ToArray();
                if (settingg.Any())
                {
                    Session["chang_color"] = arr_list_setting[0].colorbar + "|" +
                        ...
                        arr_list_setting[0].heightRight + "|" + arr_list_setting[0].widthContent + "|" +
                        arr_list_setting[0].widthRight + "|" + arr_list_setting[0].thongbao + "|" + arr_list_setting[0].chuy + "|" +
                        arr_list_setting[0].maunhanvienonline + "|" + arr_list_setting[0].maunhanviencokhach;

                    var update = db.SettingAdmins.Find(settingg[0].Id);
                ...
                else
                {
                    ...
                    var layid = (from S in db.SettingAdmins
                                 where S.Id > 0
                    ...
                    db.SettingAdmins.Add(new_setting);
                    Session["chang_color"] = arr_list_setting[0].colorbar + "|" +
                        arr_list_setting[0].cochu + "|" + arr_list_setting[0].fontchu + "|" +
                        arr_list_setting[0].mauchu + "|" + arr_list_setting[0].maucokhach + "|" +
                        arr_list_setting[0].mauonline + "|" + arr_list_setting[0].maucho + "|" +
        ...
        {
            var list_setting= db.SettingAdmins.Find(Id);
        ...
        public JsonResult CHANGGE_SETTINGGGGGG()
        {
            ...
            var list_data_setting_user = db.SettingAdmins.Where(x => x.ID_User == id_user).ToList();
