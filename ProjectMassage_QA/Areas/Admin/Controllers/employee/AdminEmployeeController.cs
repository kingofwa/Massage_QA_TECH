...
namespace ProjectMassage_QA.Areas.Admin.Controllers.employee
{
    public class AdminEmployeeController : BaseController
    {
        ...
        {
            var list = db.TypeEmployees.Where(x=>x.TE_Active == true).ToList();
            ViewData["list_typeemployee"] = list;


            var list_employee_type = (from em in db.tblEmployees
                                      join ty in db.TypeEmployees on em.TypeEmployeeId equals ty.Id
                                      //where em.E_Active==0
        ...
        public JsonResult Save_EmployeeDefault(tblEmployee[] employee)
        {
            var value = false;
            ...
            try
            {
                ...
                {
                    var employeenew = new tblEmployee();
        ...
        public JsonResult Save_EmployeeStaff(EmployeeStaff_View[] employee)
        {
            ...
            try
            {
                if (employee[0].Id > 0)
                {
                    ...
                    var update1 = db.tblStaffInEmployees.Find(employee[0].Id);
                ...
                else
                {
                    ...
                    db.tblStaffInEmployees.Add(employeenew1);
                    db.SaveChanges();
                    value = true;
                }
            ...
            var list_employee_type = (from   stack in db.tblStaffInEmployees 
        ...
        public JsonResult Delete_Employee(int Id)
        {
            ...
            try
            {
                ...
                var layid1 = db.tblStaffInEmployees.Find(Id);
                var layid2 = db.tblRegisters.Find(Id);

                db.tblEmployees.Remove(layid);
                if (layid1!=null)
                {
                    db.tblStaffInEmployees.Remove(layid1);
                }
                if (layid2 != null)
                {
                    db.tblRegisters.Remove(layid2);
                }
                db.SaveChanges();
                value = true;
            }
